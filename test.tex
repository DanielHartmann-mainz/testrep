...
\Aufgabe{1}
\begin{enumerate}[a)]
    \item Formeln lassen sich einfach mit zwei \$-Zeichen den Text integrieren: $\frac{a + b}{c} = 1$ . FÃ¼r eine LÃ¤ngere Formel, die in einer eigenen Zeile stehen soll kÃ¶nnen doppelte \$-Zeichen verwendet werden:
$$ \frac{a + b}{c} = 1 \Rightarrow a + b = c $$
    \item Nummerierte Formeln bietet die \emph{equation}-Umgebung:
        \begin{equation}
            ...
            \label{myequation}
        \end{equation}
        SpÃ¤ter kann Formel \ref{myequation} referenziert werden. 
    \item Mehrzeilige Formeln kÃ¶nnen durch die \emph{align}-Umgebung realisiert werden:
        \begin{align*}
            ggT(15, 12) &= ggT(3, 12) \\
                        &= ggT(3, 9) \\
                        &= ggT(3, 6) \\
